   ...
   app.put('/property/:id', async (req, res) => {
    pool.getConnection(function (err, connection){
     if(err){
       ...
       payload.allowsSmoking, payload.img, payload.tag1, payload.tag2, payload.tag3, payload.tag4, payload.tag5, payload.tag6, payload.tag7, payload.property_id], function (err, rows, fields) {
         connection.release();
         if (err) {
